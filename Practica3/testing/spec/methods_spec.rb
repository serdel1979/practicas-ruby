...
describe '#incrementar' do
    describe 'cuando el valor es numérico' do
        it 'incrementar el valor de un delta recibido por parámetro' do
            x = -9
            delta= 10
            assert_equal(1, incrementar(x, delta))
        end
        
        it 'incrementar el valor en un delta de 1 unidad por defecto' do
            x = 10
...
describe '#concatenar' do
  describe '#concatenar' do
    it 'concatena todos los parámetro que recibe en un string, separando por espacios' do
      class Dummies; end
